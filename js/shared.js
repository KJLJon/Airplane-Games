...
const Scores = {
  ...
  getAll() {
    const games = ['tetris','sudoku','runner','chess-puzzles','sliding-puzzle','snake','traffic','minesweeper','wordle','2048','dogfight','maze','stratego','nonogram','flapper','simon','multiplier-runner','lane-shooter','slide-dash','orb-merge','sky-slope','turbo-tunnels'];
    const result = {};
